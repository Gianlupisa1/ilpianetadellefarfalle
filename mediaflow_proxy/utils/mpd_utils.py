    ...
    for period in periods:
        ...
        for adaptation in period["AdaptationSet"]:
            ...
            for representation in representations:
                if "video" in adaptation.get("@mimeType","") and (int(representation.get("@height", 0)) < 720) and any(int(r.get("@height", 0)) >= 720 for a in period["AdaptationSet"] if "video" in a.get("@mimeType","") for r in (a["Representation"] if isinstance(a["Representation"], list) else [a["Representation"]])): continue
